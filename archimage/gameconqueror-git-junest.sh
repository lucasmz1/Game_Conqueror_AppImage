...
APP=gameconqueror-git
BIN="gameconqueror"
DEPENDENCES="ca-certificates polkit wayland"
...
LIBSAVED="pk p11 alsa jack pipewire pulse libscanmem.la $lib_browser_launcher" # Enter here keywords or file/directory names to save in /usr/lib
